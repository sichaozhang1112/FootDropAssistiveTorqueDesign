...
%%
[ Ta,Tp,Fgx,Fgy,Q,S,Tm17 ] = NeuroMusculoSkeletal( x,x_dot,y,y_dot,theta,theta_dot,u,v );
[ DMatrix,CMatrix,GMatrix,TMatrix,TauMatrix ] = EOMMatrix( x,x_dot,y,y_dot,theta,theta_dot,Ta,Tp,Fgx,Fgy );
[ DeviceTauMatrix ] = DeviceTau( Tm17 );

xytheta_dotdot = inv(DMatrix)*(TauMatrix+DeviceTauMatrix-TMatrix-GMatrix-CMatrix*xytheta_dot);
