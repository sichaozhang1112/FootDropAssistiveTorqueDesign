...
for ii = 1 : 2
    hold on;
    subplot(3,2,ii)
    plot(linspace(0,100,EndNum),Theta(:,ii+4)-Theta(:,ii+6)-0.576*180/pi,Pattern);
    grid on;
    xlabel('gait(%)');
    ...
    hold on;
    subplot(3,2,ii+2)
    plot(linspace(0,100,EndNum),Theta(:,ii+4)-Theta(:,ii+2),Pattern);
    grid on;
    xlabel('gait(%)');
    ...
    hold on;
    subplot(3,2,ii+4)
    plot(linspace(0,100,EndNum),Theta(:,2)-Theta(:,ii+2),Pattern);
    grid on;
    xlabel('gait(%)');
