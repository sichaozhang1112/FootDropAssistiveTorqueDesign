...
%%
[ u,v ] = NeuralStateThisTime( t );

%%
xytheta_dot = [x_dot(2);y_dot(2);theta_dot];

%%
[ Ta,Tp,Fgx,Fgy ] = NeuroMusculoSkeletal( x,x_dot,y,y_dot,theta,theta_dot,u,v );
...
state_dot = [x_dot(2);x_dotdot(2);y_dot(2);y_dotdot(2);theta_dot;theta_dotdot];
