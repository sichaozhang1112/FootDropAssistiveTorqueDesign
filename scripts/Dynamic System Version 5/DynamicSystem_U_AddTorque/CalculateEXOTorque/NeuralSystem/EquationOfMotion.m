...
%%
[ x,x_dot,y,y_dot,theta,theta_dot ] = BodyStateThisTime(t);

u = state(1:14,1);
v = state(15:28,1);

%%
[ Q,S ] = NeuroMusculoSkeletal( x,x_dot,y,y_dot,theta,theta_dot,u,v );
...
% 
u_dot(13) = 0.01*u_dot(13); % u(13)
u_dot(14) = 0.9*u_dot(14); % u(14)

%%
state_dot = [u_dot;v_dot];
