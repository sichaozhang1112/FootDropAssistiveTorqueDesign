...
load('Gait_Tm_Analyze.mat');Color = [1 0.5 0];Pattern = '-'; Name = 'Foot Drop';
...
load('Gait_Tm_AddTorque_Analyze.mat');Color = [1 0 0.5];Pattern = '--'; Name = 'Foot Drop with Torque';% foot drop with torque
StanceStartNum = SgStartNum(4,1);
SwingEndNum = SgStartNum(4,2);
EndNum = SwingEndNum-StanceStartNum+1;
Theta = theta(StanceStartNum:SwingEndNum,:)*180/pi;
